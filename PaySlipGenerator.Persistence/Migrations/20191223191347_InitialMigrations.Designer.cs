...
namespace PaySlipGenerator.Persistence.Migrations
{
    ...
    [Migration("20191223191347_InitialMigrations")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PaySlipGenerator.Entity.Employee", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PaySlipGenerator.Entity.PaymentRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PaySlipGenerator.Entity.TaxYear", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PaySlipGenerator.Entity.PaymentRecord", b =>
                {
                    b.HasOne("PaySlipGenerator.Entity.Employee", "Employee")
                        .WithMany("PaymentRecord")
                        .HasForeignKey("EmployeeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PaySlipGenerator.Entity.TaxYear", "TaxYear")
                        .WithMany()
